...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "inline-flex h-9 w-fit items-center justify-center rounded-lg bg-[var(--gray)] p-[3px] text-[var(--light-white)]",
        className,
      )}
      {...props}
    />
